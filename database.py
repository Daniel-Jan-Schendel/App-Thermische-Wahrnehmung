...
with tab_4:
    ...
    with c1:
        safe_st_image("neon/images/neon_01.jpg", "Abbildung 1: Initialisierung des Cloud-Projekts auf AWS Frankfurt.")
        st.markdown(
    ...
    with c2:
        safe_st_image("neon/images/neon_02.jpg", "Abbildung 2: Architektur-Übersicht der Compute-Ressourcen im Neon-Dashboard.")
        st.markdown(
    ...
    with c3:
        safe_st_image("neon/images/neon_03.jpg", "Abbildung 3: Detaillierte Projekt-Übersicht und Verbindungsparameter.")
        st.markdown(
    ...
    with c4:
        safe_st_image("neon/images/neon_04.jpg", "Abbildung 4: SQL DDL-Skript im integrierten Neon SQL Editor.")
        st.markdown(
    ...
    with c5:
        safe_st_image("neon/images/neon_05.jpg", "Abbildung 5: Robustes Python-Skript.")
        st.markdown(
    ...
    with c6:
        safe_st_image("neon/images/neon_06.jpg", "Abbildung 6: Strukturierte Tabellen-Ansicht innerhalb der Neon-Datenbank-Konsole.")
        st.markdown(
    ...
    with c7:
        safe_st_image("neon/images/neon_07.jpg", "Abbildung 7: Konfiguration der nativen PostgreSQL-Schnittstelle in Power BI.")
        st.markdown(
    ...
    c8, _ = st.columns([1,1])
    with c8:
        safe_st_image("neon/images/neon_08.jpg", "Abbildung 8: Ausführung und Laden der Daten in die BI-Umgebung.")
        st.markdown(
    ...
    with c9:
        safe_st_image("neon/images/neon_09.jpg", "Abbildung 9: Komponenten-Übersicht des Datenmodells.")
        st.markdown(
    ...
    with c10:
        safe_st_image("neon/images/neon_10.jpg", "Abbildung 10: Finales Schema.")
        st.markdown(
    ...
    with c11:
        safe_st_image("neon/images/neon_11.jpg", "Abbildung 11: Power Bi Relationales Datenmodell.")
